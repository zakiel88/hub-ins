...
export class ProductsV2Controller {
    ...
    async runMigration() {
        ...
        const migrations = [
            ...
            `CREATE INDEX idx_pi_product ON product_issues(product_id)`,
            `CREATE INDEX idx_pi_variant ON product_issues(variant_id)`,
            `CREATE INDEX idx_pi_status ON product_issues(status)`,
        ];
